...
(() => {
  ...
  const styles = ["mauve", "blue", "sage", "apricot", "oat"];
  ...
  function read() {
    try {
      ...
      return {
        mode: modes.includes(value?.mode) ? value.mode : "light",
        style: styles.includes(value?.style) ? value.style : "blue"
      };
    } catch {
      return { mode: "light", style: "blue" };
    }
  }
