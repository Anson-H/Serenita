...
export function BodyMetricWorkspace({
  ...
  const { offset, setOffset, date, setDate, customEnd, setCustomEnd, period, setPeriod, source, setSource, metric, setMetric, hours, setHours, dates, shift } = filters;
          ...
          {information ? (
            ...
            <>
              ...
              <div className="bm-detail-scroll scroll-content content-column">
                ...
                <div className="bm-date-navigation" data-period={period}>
                  <button
                    type="button"
                    className="control"
                    aria-label="上一时间范围"
