...
import { LAB_FLAG_TEXTS, REPORT_TYPES } from "../../api/reports/reportTypes";
import type { CreateReportInput, LabFlagText, ReportType } from "../../api/reports/reportTypes";

import type { LabDictionaryResponse } from "../../api/knowledge/labDictionaryApi";
...
export function ReportCreateFlow({
  ...
  useEffect(() => {
    ...
    void labDictionaryApi.fetchMemberLabDictionary(workspace.memberId)
      .then((response) => {
        if (cancelled) return;
