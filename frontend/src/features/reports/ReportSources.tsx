...
import type { ReportDetail, ReportSourceFile } from "../../api/reports/reportTypes";
...
function ReportSourceThumbnail({ file, loading, onOpen, memberId, reportId, sourceCount }: {
  ...
  useEffect(() => {
    ...
    void reportApi.fetchReportSourceThumbnailBlob(memberId, reportId, file.resource_id, controller.signal)
      .then((blob) => {
