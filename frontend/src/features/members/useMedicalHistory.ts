...
import { fetchMedicalHistory, updateMedicalHistory, type MedicalHistory, type MedicalHistoryChanges, type MedicalHistoryField } from "../../api/medicalHistory/medicalHistoryApi";
