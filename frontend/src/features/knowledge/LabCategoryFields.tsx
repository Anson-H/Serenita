...
import type { LabDictionaryCategory, LabDictionaryItem, LabDictionaryResponse } from "../../api/knowledge/labDictionaryApi";
...
import type { CategoryDraft, DictionaryTab } from "./labDictionary/labDictionaryDrafts";
import {
