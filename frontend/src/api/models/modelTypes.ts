...
export type ProviderSummary = {
  provider_kind: "managed" | "builtin" | "custom";
  provider_id: string;
...
export type ModelServiceStatus = "available" | "offline" | "unconfigured" | "disconnected" | "unreachable" | "access_denied";
...
export type ModelDefaults = {
  ...
  memory_generation: AddedModel | null;
