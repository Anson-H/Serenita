...
export function fetchLabDictionary() {
  return request<LabDictionaryResponse>("/knowledge/lab-dictionary");
}

export function createLabDictionaryItem(input: LabItemWriteInput) {
  return request<LabDictionaryMutationResponse>("/knowledge/lab-dictionary/items", {
    method: "POST",
...
export function updateLabDictionaryItem(itemId: string, input: LabItemWriteInput) {
  return request<LabDictionaryMutationResponse>(
    `/knowledge/lab-dictionary/items/${encodeURIComponent(itemId)}`,
...
export function mergeLabDictionaryItems(
  ...
  return request<LabDictionaryMutationResponse>(
    `/knowledge/lab-dictionary/items/${encodeURIComponent(sourceItemId)}/merge`,
    {
      method: "POST",
      body: JSON.stringify({
...
export function createLabDictionaryCategory(input: LabCategoryWriteInput) {
  return request<LabDictionaryMutationResponse>("/knowledge/lab-dictionary/categories", {
    method: "POST",
    body: JSON.stringify(input)
  });
}
...
export function updateLabDictionaryCategory(
  ...
  return request<LabDictionaryMutationResponse>(
    `/knowledge/lab-dictionary/categories/${encodeURIComponent(currentCategoryName)}`,
    { method: "PATCH", body: JSON.stringify(input) }
  );
}
...
export function deleteLabDictionaryCategory(
  ...
  return request<LabDictionaryMutationResponse>(
    `/knowledge/lab-dictionary/categories/${encodeURIComponent(categoryName)}`,
    {
      method: "DELETE",
      body: JSON.stringify({
        expected_dictionary_revision: expectedDictionaryRevision
