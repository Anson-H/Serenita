import { assertAuthContext, captureAuthContext, isAuthContextCurrent } from "../auth/authLifecycle";
import {
  parseContextResourceUploadResponse,
  type ContextResourceUploadResponse
} from "./contextResourceUpload";
import { API_BASE_URL, apiResponseError, networkFailureMessage, request, requestResponse } from "../transport/request";
import {
  CancelTurnResponse,
  ConversationDetail,
