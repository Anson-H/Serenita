...
import { useConversationAttachments } from "../../features/conversations/useConversationAttachments";
import { useConversationLayout } from "../../features/conversations/useConversationLayout";
import { useConversationLifecycle } from "../../features/conversations/useConversationLifecycle";
import { useConversationMessageActions } from "../../features/conversations/useConversationMessageActions";
import { useConversationModelControl } from "../../features/conversations/useConversationModelControl";
import { useConversationPageState } from "../../features/conversations/useConversationPageState";
import { useConversationViewState } from "../../features/conversations/useConversationViewState";
import { useConversationWorkspace } from "../../features/conversations/useConversationWorkspace";
import { useFavoriteMessageActions } from "../../features/favorites/useFavoriteMessageActions";
import { useFavoriteWorkspace } from "../../features/favorites/useFavoriteWorkspace";
import { useReportWorkspace } from "../../features/reports/useReportWorkspace";
import {
  APP_PATH,
  REPORTS_PATH,
  chatPathForSession,
...
import { useWorkspaceRouteShell } from "../WorkspaceRouteShell";
...
export function useWorkspacePageModel({
  ...
  const reportWorkspace = useReportWorkspace({
    ...
    active: Boolean(reportMember) && (reportRouteActive || healthRouteActive),
    favorites,
