...
from backend.app.storage.schema import Column, ColumnGroup as G, Table, CheckConstraint as Check, Index

MEMBER_LIFECYCLE_TASKS_TABLE = Table("member_lifecycle_tasks", (
        ...
        Column("next_attempt_at", "DATETIME", G.STATE, nullable=False),
