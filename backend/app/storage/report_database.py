    ...
    tables=(
        Table(
            ...
            columns=(
                ...
                Column("report_time", "DATETIME", ColumnGroup.DATA, nullable=False),
                ...
                Column("analysis_updated_at", "DATETIME", ColumnGroup.STATE),
        ...
        Table(
            ...
            columns=(
                ...
                Column("last_attempt_at", "DATETIME", ColumnGroup.STATE),
                Column("created_at", "DATETIME", ColumnGroup.AUDIT, nullable=False),
            ),
        ...
        Table(
            ...
            columns=(
                ...
                Column("started_at", "DATETIME", ColumnGroup.DATA, non_blank=True),
                Column("ended_at", "DATETIME", ColumnGroup.DATA, non_blank=True),
