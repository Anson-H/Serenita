...
from backend.app.plugins.report.runtime_service import RuntimeReportService
...
from backend.app.plugins.report.tools import (
...
def build_tools(*, runtime_context: PluginRuntimeContext) -> list[Tool]:
    ...
    service = RuntimeReportService(
        ...
        runtime_context.conversation_resource_resolver,
        runtime_context.message_resolver,
    )
    return [
        ReadReportCatalogTool(
...
from backend.app.plugins.report.resources import (
