...
from backend.app.core.runtime.member_lifecycle import member_lifecycle_change
from backend.app.application.accounts.member_lifecycle_tasks import MemberLifecycleTasks

from backend.app.application.accounts.auth_service import normalize_account
...
class MemberService:
    def __init__(
        ...
        *,
        ...
        self.lifecycle_tasks = MemberLifecycleTasks(
            self.paths, lambda: self.conversations
        )
    ...
    def create_member(
        ...
        *,
        ...
        member_id = self.repository.create(
            actor_account_id, values, set_as_default=set_as_default
        )
    ...
    def delete_member(self, actor_account_id: str, member_id: str) -> dict[str, Any]:
        ...
        self.notifications.resources_changed(
            member_id=member_id, account_ids=affected_accounts
        )
    ...
    def revoke(
        ...
        self.notifications.resources_changed(
            member_id=member_id, account_ids=(actor_account_id, account_id)
        )
        self.lifecycle_tasks.drain()
        return self.grants(actor_account_id)
