...
from backend.app.application.models.attachment_capabilities import (
...
class ConversationInputs(ModelAttachmentCapabilities):
    def __init__(self, repository, members, model_catalog, plugin_service, events):
