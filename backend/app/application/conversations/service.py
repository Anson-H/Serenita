...
from backend.app.application.conversations.maintenance import ConversationTaskMaintenance
...
from backend.app.application.conversations.queue import (
    ConversationQueue,
...
from backend.app.core.runtime.conversation_tasks import tasks_for_paths
from backend.app.repositories.conversations.repository import ConversationRepository
...
class ConversationService:
    ...
    def __init__(
        ...
        *,
        ...
        self.model_calls = ModelCallRecorder(
            ...
            check_resources=self.inputs.validate_context_resources,
        )
        ...
        self.maintenance = ConversationTaskMaintenance(
            self.task_state, self.lifecycle.interrupt_expired_turn_jobs
        )
    ...
    def stream_events(self, account_id: str, session_id: str, stream_id: str):
        self.maintenance.reconcile([account_id])
    ...
    def send_message(
        ...
        *,
        ...
        return self.submissions.send_message(
            account_id,
            session_id,
            raw_text,
            model_id,
    ...
    def regenerate_message(
        ...
        return self.submissions.regenerate_message(
            account_id, session_id, message_id, model_id, thinking_mode
        )
    ...
    def edit_message(
        ...
        return self.submissions.edit_message(
            account_id,
            session_id,
            message_id,
            raw_text,
    ...
    def interrupt_member_session(
        self, account_id: str, session_id: str, *, before: str | None = None
    ) -> None:
        return self.lifecycle.interrupt_member_session(
            account_id, session_id, before=before
        )
    ...
    def cancel_turn(
        ...
        *,
        ...
        return self.lifecycle.cancel_turn(
            account_id, session_id, turn_id, preserve_partial, reason=reason
        )
    ...
    def list_conversations(
        ...
        for session in result["sessions"]:
            if session["pending_turn_status"] == "queued" or (
                session["pending_turn_status"] is None and session["queued_input_count"]
            ):
    ...
    def source_message_for_favorite(
        ...
        return self.queries.source_message_for_favorite(
    ...
    def update_conversation(
        ...
        *,
        ...
        return self.sessions.update_conversation(
